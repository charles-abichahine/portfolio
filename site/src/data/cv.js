...
export const experience = [
  ...
  },
  {
    ...
    where: 'Beirut',
    points: [
      'Developed a LOD 300 BIM model for Hotel Norman’s Cay Villas (Bahamas), collaborating with engineers, structural architects, and interior designers.',
      'Modeled parametric families, furniture elements, and shop drawings to project specifications.',
    ],
  },
  {
    dates: '2022–',
...
export const skills = [
  { group: 'Design & Modeling', items: ['Rhinoceros 3D', 'Grasshopper', 'Revit'] },
  { group: 'Computation & AI', items: ['Python', 'Generative AI workflows', 'Wasp / Kangaroo'] },
  { group: 'Visualization', items: ['V-Ray', 'D5 Render', 'Enscape', 'Adobe Suite'] },
]
...
export const certificates = [
  'Volume Zero | Top 50 | Marsception 24',
  'Design Interventions | Parametric Architecture',
  'PA | AI Augmented Creative Workflows',
  'PA | Taking Control 4.0',
  'PA | Revit Flow',
]
